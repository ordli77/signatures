...
def get_costs(params,Sigma):
    ...
    #try:
    with open("midprice of n={},H={} and order{}.txt".format(params["n_step"],params["H"],params["order"],Sigma), "w") as txt_file:
        for line in paths:
    ...
    with open("coeffecient{}.txt".format(Sigma), "w") as f:
    ...
    with open("results of steps {}, Hurst {},{} and order {}.txt".format(params["n_step"],params["H"],Sigma,params["order"]), "w") as file:
